...
\item each node has standard deviation of 0.3
\item different obstacles (circle, crosses, etc.)
\vspace{10pt}
\begin{center}
	\includegraphics[height=130pt]{smiley.pdf}
\end{center}
\end{itemize}
...
\vspace{10pt}
\begin{center}
	\includegraphics[height=130pt]{smiley_zoom1.pdf}
\end{center}
\end{itemize}
...
\vspace{10pt}
\begin{center}
	\includegraphics[height=130pt]{zoom.pdf}
\end{center}
\end{itemize}
