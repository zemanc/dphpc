...
\begin{figure}[h]\centering
  \includegraphics[scale=0.245]{insert2.eps}
  \caption{Insert node into list \label{fig:insert}}
\end{figure}
...
\begin{figure}[h]\centering
  \includegraphics[scale=0.245]{remove2.eps}
  \caption{Remove node from list. Note: The pointers of the removed node remain so that a traversing thread won't get lost. \label{fig:remove}}
\end{figure}
