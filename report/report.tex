...
\caption{Parallel Fringe Search\label{algo:par}. Note: The locking mechanism is not part of this pseudocode, but it's thoroughly described in several paragraphs in section \ref{sec:impl} and in figures \ref{fig:lock}, \ref{fig:insert} and \ref{fig:remove}).}
\end{algorithm}
