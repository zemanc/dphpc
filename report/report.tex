...
\end{compactitem}
As you can see in figure \ref{fig:lock_bench} the inline assembly locks were significantly faster than the OpenMP locks. Therefore we used the test-and-set lock for our implementation and also the following benchmarks are based on the implementation with these locks.
...
\mypar{Lazy removal versus normal removal}
...
\begin{figure}[h]\centering
  ...
  \caption{The speeeeeeeedup. \label{fig:speedup}}
\end{figure}
