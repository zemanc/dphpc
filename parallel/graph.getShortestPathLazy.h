#ifndef __graph__getShortestPathLazy_h__

#define __graph__getShortestPathLazy_h__
...
template<class F>
length_t Graph::getShortestPathLazy(index_t from, index_t to, std::list<Node*>* vals, const F& dist)
{
#ifdef DEBUG
lock_t s;
#endif
